  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-12">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2">Grafik Yakında Eklenecek</h3>
        <p className="text-sm text-gray-500 max-w-md leading-relaxed">
          VİOP kontrat grafikleri için entegrasyon çalışması devam etmektedir. 
          Şu an için fiyat bilgilerini ve açık pozisyon verilerini aşağıdaki bölümlerden inceleyebilirsiniz.
        </p>
      </div>
    </div>
  );
