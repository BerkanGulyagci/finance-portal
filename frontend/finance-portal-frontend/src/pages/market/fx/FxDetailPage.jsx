...
import { getFxHistory, getFxTcmb } from '../../../api/marketApi.js';
...
function FxKlineChart({ chartPoints, lineColor }) {
  ...
  useEffect(() => {
    ...
    const klineData = chartPoints
      .map(p => {
        // date formatı: "YYYY-MM-DD" → timestamp
  ...
  return (
    <div>
      <div id={chartId.current} style={{ width: '100%', height: '420px' }} />
    </div>
  );
}
