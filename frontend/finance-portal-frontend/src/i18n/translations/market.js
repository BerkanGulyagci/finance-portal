const en = {
  ...
  // ── Fon varlık dağılımı kategorileri (TEFAS) — API'den Türkçe gelir, burada İngilizceye çevrilir ──
  'Para Piyasası': 'Money Market',
  'Şirket Bono/Tahvil': 'Corporate Bond',
  'Hazine Bono/Tahvil': 'Treasury Bond',
  'Kira Sertifikası/Katılım Hesabı': 'Lease Certificate/Participation Account',
  'Diğer': 'Other',
  ...
  'Kamu Borçlanma Aracı': 'Government Debt Instrument',
  'Türev Araçlar': 'Derivatives',
  'Kıymetli Maden': 'Precious Metal',
  'Eurobond': 'Eurobond',
