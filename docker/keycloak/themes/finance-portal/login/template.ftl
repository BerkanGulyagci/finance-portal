...
<body id="keycloak-bg" class="${properties.kcBodyClass!} fp-auth-body">

<div class="fp-auth-page">
  <div class="fp-auth-shell">
    <div class="fp-auth-container">
      <div class="fp-sr-only">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</div>
      ...
      <main class="fp-auth-card ${properties.kcLoginMain!}" id="fp-auth-main">
        ...
        <div class="${properties.kcLoginMainHeader!} fp-auth-card-heading">
          <h1 class="${properties.kcLoginMainTitle!} fp-auth-page-title" id="kc-page-title"><#nested "header"></h1>
        ...
        <div class="${properties.kcLoginMainBody!} fp-auth-card-body">
        ...
        <#if displayMessage && message?has_content && (message.type != 'warning' || !isAppInitiatedAction??)>
            <div class="${properties.kcAlertClass!} pf-m-${(message.type = 'error')?then('danger', message.type)} fp-auth-alert">
        ...
        <div class="pf-v5-c-login__main-footer fp-auth-card-foot">
