...
class PriceAtDateToolTest {
    ...
    void execute_exactDateMatch_returnsClose() {
        ...
        assertThat(r).contains("GRAM");
        assertThat(r).contains("2025-01-10");
        assertThat(r).contains("3060.19");                  // stripTrailingZeros uygulanmış
        assertThat(r).doesNotContain("en yakın iş günü");   // tam eşleşme
    }
    ...
    void execute_floorsToPreviousBusinessDay() {
        ...
        assertThat(r).contains("2025-01-10");
        assertThat(r).contains("en yakın iş günü");
    }
