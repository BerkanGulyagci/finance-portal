...
public class EvdsBondService {
    ...
    public List<EvdsBondInstrument> getEvdsBondsAll() {
        ...
        // Limit uygulanmaz — tüm aktif kıymetler
        ...
        log.info("[EvdsBondService] {} aktif kıymet işlenecek.", instrumentCodes.size());
        ...
        for (String code : instrumentCodes) {
            try {
                ...
                EvdsBondInstrument instrument = buildInstrument(code, info, hasCoupon);
