...
/**
 * Kafka'ya gönderilecek request log event'i.
 * Console JSON log ile aynı alanları içerir.
 * null alanlar JSON'a dahil edilmez.
 */
...
public class RequestLogEvent {
    ...
    public static class Builder {
        ...
        public RequestLogEvent build() { return event; }
    }
